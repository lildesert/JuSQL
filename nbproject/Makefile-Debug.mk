...
${OBJECTDIR}/UI/Attribut.o: UI/Attribut.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/Attribut.o UI/Attribut.cpp

${OBJECTDIR}/UI/Relation.o: UI/Relation.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/Relation.o UI/Relation.cpp

${OBJECTDIR}/UI/common.o: UI/common.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/common.o UI/common.cpp

${OBJECTDIR}/UI/content_manager.o: UI/content_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/content_manager.o UI/content_manager.cpp

${OBJECTDIR}/UI/files.o: UI/files.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/files.o UI/files.cpp

${OBJECTDIR}/UI/interface.o: UI/interface.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/interface.o UI/interface.cpp

${OBJECTDIR}/UI/main.o: UI/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/main.o UI/main.cpp

${OBJECTDIR}/UI/pages_manager.o: UI/pages_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/pages_manager.o UI/pages_manager.cpp

${OBJECTDIR}/UI/schema.o: UI/schema.cpp 
	${MKDIR} -p ${OBJECTDIR}/UI
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/UI/schema.o UI/schema.cpp
